...
export const routes: Routes = [
    ...
    { path: "lots", loadComponent: () => import("./pages/lots/lots").then(m => m.AuctionLots), resolve: { db: DbInitResolver } },
    {
        path: "buyers",
        children: [
            { path: "", loadComponent: () => import("./pages/buyers/buyers").then(m => m.AuctionBuyers), resolve: { db: DbInitResolver } },
            { path: "buyer-lots", loadComponent: () => import("./pages/buyer-lots/buyer-lots").then(m => m.BuyerLots), resolve: { db: DbInitResolver } }
        ]
    },
